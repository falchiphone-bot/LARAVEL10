                                ...
                                <div class="card-header">
                                    <div class="badge bg-primary text-wrap"
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input required type="datetime-local" class="form-control" id='inicio'
                                                name="inicio" value="{{ $evento->startDateTime->format('Y-m-d\TH:i') }}">
                                        </div>
                                        <div class="col-sm-2">
                                            <label for="fim">Fim do evento</label>
                                            <input required type="datetime-local" class="form-control" id='fim'
                                                name="fim" value="{{ $evento->endDateTime->format('Y-m-d\TH:i') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-header">
