        ...
        <div class="container">
            ...
            <div class="card">
                ...
                ;font-size: 24px; lign=˜Center˜">
                    UPLOAD DE ARQUIVO PARA SERVIDOR LOCAL NO SISTEMA DE GERENCIAMENTO ADMINISTRATIVO E CONTÁBIL
                </div>
                ...
                <div class="card-body">
                    ...
                    <nav class="navbar navbar-red" style="background-color: hsla(234, 92%, 47%, 0.096);">
                        <a class="btn btn-warning" href="/LancamentosDocumentos">Retornar a lista de opções</a>
                    ...
                    @endcan
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="POST" action="../drivelocal/file-upload" enctype="multipart/form-data">
                                    @csrf
                                    <label for="fim">Complemento para o arquivo. LIMITADO A 150 CARACTERES.</label>



                                    <textarea required name="complemento" id="complemento" cols="1" rows="3" class="form-control" style="background-color: rgb(11, 15, 221); color: white;"></textarea>



                                    <input required type="file" class="btn btn-danger" name="arquivo">
                                    <p class="my-2">
                                        <button type="submit" class="btn btn-success">Enviar o arquivo para a pasta do sistema no servidor local.</button>
                                    </p>
                                </form>
                            </div>
                        </div>
