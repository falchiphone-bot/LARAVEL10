...
{{-- @section('content') --}}
    <h1 class="text-center">O que tem Permissões</h1>
    <hr>

    <a href="{{ route('TemPermissoes.create') }}" class="btn btn-primary btn-lg enabled" tabindex="-1" role="button"
                ...
                <td>
                    <div class="row mt-2">
                        <div class="col-6">
                            ...
                            <a href="{{ route('TemPermissoes.show', $cadastro->permission_id) }}" class="btn btn-info btn-sm enabled"
