            ...
            <div class="card-body">
                ...
                <div class="row">
                    <form method="POST" action="/LeituraArquivo/SelecionaDatasExtratoSicrediPJ" enctype="multipart/form-data">
                        @csrf
                        <label for="fim"></label>
                        <div class="badge bg-success text-wrap" style="width: 100%; font-size: 24px; color: white; text-align: center;">
                ...
                <div class="row">
                    ...
                    <form method="POST" action="/LeituraArquivo/SelecionaDatas" enctype="multipart/form-data">
                        ...
                        <div class="badge bg-info text-wrap" style="width: 100%; font-size: 24px; color: black; text-align: center;">
                            {{-- <input type="file" required class="btn btn-success" name="arquivo" accept=".csv, text/csv"> --}}
                ...
                <div class="row">
                    <form method="POST" action="/ConectCar/ExtratoConectCar" enctype="multipart/form-data">
                        @csrf
                        <label for="fim"></label>
                        <div class="badge bg-success text-wrap" style="width: 100%; font-size: 24px; color: white; text-align: center;">
