        ...
        <div class="container">
            ...
            <div class="card">
                ...
                ;font-size: 24px; lign=˜Center˜">
                    INFORMAR VALORES PARA CALCULAR TABELA PRICE NO SISTEMA DE GERENCIAMENTO ADMINISTRATIVO E CONTÁBIL
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <form method="POST" action="/lancamentos/tabelaprice" enctype="multipart/form-data">
                            @csrf
            ...
            ;font-size: 24px; lign=˜Center˜">
                ...
                ;font-size: 24px; lign=˜Center˜">
                    ...
                    <br>
                    <p class="my-2">
                        <button type="submit" class="btn btn-success">Enviar calcular</button>
                    </p>
                    </form>
                </div>
            </div>
