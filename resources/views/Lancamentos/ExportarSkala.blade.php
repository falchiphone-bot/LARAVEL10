        ...
        <div class="container">
            ...
            <div class="card">
                <div class="badge bg-primary text-wrap" style="width: 100%;font-size: 24px;lign=˜Center˜">
                    EXPORTAR ARQUIVO PARA SKALA DO SISTEMA DE GERENCIAMENTO ADMINISTRATIVO E CONTÁBIL
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <hr>
                <form method="POST" action="/Lancamentos/ExportarSkalapost" accept-charset="UTF-8">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
