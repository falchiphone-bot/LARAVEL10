...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($tabelaParcelas as $parcela) { ?>
                <tr>
                    <td><?php echo $parcela['Parcela']; ?></td>
                    <td><?php echo number_format($parcela['Amortização'], 2, ',', '.'); ?></td>
                    <td><?php echo number_format($parcela['Juros'], 2, ',', '.'); ?></td>
                    <td><?php echo number_format($parcela['Total'], 2, ',', '.'); ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
