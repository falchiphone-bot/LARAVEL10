                                        ...
                                        <div class="card-body py-2 d-flex flex-column gap-2">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center gap-2">
                                                ...
                                                @can('backup.executar.ftp')
                                                    <a href="{{ route('ftp.index') }}" class="btn btn-outline-primary btn-sm d-inline-flex align-items-center" title="Abrir navegador para realizar download de arquivos do FTP (bloqueado no IP do servidor)">
