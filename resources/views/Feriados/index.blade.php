        ...
        <div class="container">
            ...
            <div class="card">
                <div class="badge bg-primary text-wrap" style="width: 100%;font-size: 24px;lign=˜Center˜">
                    FERIADOS PARA SISTEMA DE GERENCIAMENTO ADMINISTRATIVO E CONTÁBIL
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="card-header">
                    <div class="badge bg-info text-wrap" style="width: 100%;font-size: 24px">
                        <p>Total de feriados cadastrados no sistema de gerenciamento administrativo e contábil:
                            {{ $feriados->count() ?? 0 }}</p>
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach ($feriados as $feriado)
                            <tr>
                                ...
                                @can('FERIADOS- EDITAR')
                                    <td>
                                        <a href="{{ route('Feriados.edit', $feriado->id) }}" class="btn btn-success" tabindex="-1"
                                ...
                                @can('FERIADOS- VER')
                                    <td>
                                        <a href="{{ route('Feriados.show', $feriado->id) }}" class="btn btn-info" tabindex="-1"
