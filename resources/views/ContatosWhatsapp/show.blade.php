        ...
        <div class="container">
            ...
            <div class="card">
                <div class="badge bg-primary text-wrap" style="width: 100%;">
                    CONTATO DO WHATSAPP DO SISTEMA DE GERENCIAMENTO ADMINISTRATIVO E CONTÁBIL
                </div>
                ...
                <div class="row">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>
                                NOME: {{ $cadastro->contactName}}
                            </p>
                            <p>
                                TELEFONE {{ $cadastro->recipient_id}}
                            </p>

                        </div>
                        <div class="card-footer">
                            <a href="{{ route('ContatosWhatsapp.index') }}">Retornar para a lista</a>
                        </div>
                    </div>
                </div>
            </div>
