        ...
        <div class="row">
            ...
            <div class="col-2">
                ...
                <input class="form-control @error('created_at') is-invalid @else is-valid @enderror" name="created_at"
                    ...
                    value="{{ $formattedDate = date('d/m/y H:i', strtotime($model->created_at)) ?? null }} " disabled>
                @error('created_at')
            ...
            <div class="col-2">
                ...
                <input class="form-control @error('updated_at') is-invalid @else is-valid @enderror" name="updated_at"
                    type="text" id="updated_at"
                    value="{{ $formattedDate = date('d/m/y H:i', strtotime($model->updated_at)) ?? null }} " disabled>
                @error('updated_at')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-8">
                ...
                <input required class="form-control @error('user_updated') is-invalid @else is-valid @enderror"
                    name="user_updated" type="text" id="user_updated" value="{{ $model->user_updated ?? null }}"
                    disabled>
                @error('user_updated')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="col-10">
                ...
                <input required class="form-control @error('contactName') is-invalid @else is-valid @enderror"
                    name="contactName" type="text" id="contactName" value="{{ $model->contactName ?? null }}">
                @error('contactName')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-4">
                ...
                <input required class="form-control @error('recipient_id') is-invalid @else is-valid @enderror"
                    name="recipient_id" type="text" id="recipient_id" value="{{ $model->recipient_id ?? null }}">
                @error('recipient_id')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-2">
                ...
                <input class="form-control @error('quantidade_nao_lida') is-invalid @else is-valid @enderror"
                    name="quantidade_nao_lida" type="text" id="quantidade_nao_lida"
                    value="{{ $model->quantidade_nao_lida ?? null }}">
            ...
            <div class="col-10">
                ...
                <input class="form-control @error('user_atendimento') is-invalid @else is-valid @enderror"
                    name="user_atendimento" type="text" id="user_atendimento"
                    value="{{ $model->user_atendimento ?? null }}">
            ...
            <div class="col-12">
                ...
                <input class="form-control @error('transferido_para') is-invalid @else is-valid @enderror"
                    name="transferido_para" type="text" id="transferido_para"
                    value="{{ $model->user_atendimento ?? null }}">
            ...
            <div class="col-2">
                ...
                <input class="form-control @error('ultima_entrega') is-invalid @else is-valid @enderror"
                    name="ultima_entrega" type="text" id="ultima_entrega"
                    value="{{ $formattedDate = date('d/m/y H:i', strtotime($model->ultima_entrega)) ?? null }} "
                    disabled>
            ...
            <div class="col-2">
                ...
                <input class="form-control @error('ultima_leitura') is-invalid @else is-valid @enderror"
                    name="ultima_leitura" type="text" id="ultima_leitura"
                    value="{{ $formattedDate = date('d/m/y H:i', strtotime($model->ultima_leitura)) ?? null }} "
                    disabled>
                ...
                <div class="col-6">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" name="status_mensagem_entregue" type="checkbox"
                            @if ($model->status_mensagem_entregue) checked @endif value="1"
                            id="status_mensagem_entregue">
                    </div>
                </div>
            </div>
                ...
                <div class="col-6">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" name="ocultar_lista_atendimento" type="checkbox"
                            @if ($model->ocultar_lista_atendimento) checked @endif value="1"
                            id="ocultar_lista_atendimento">
                    </div>
                </div>
            </div>
                ...
                <div class="col-6">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" name="alerta_mensagem_recebida" type="checkbox"
                            @if ($model->alerta_mensagem_recebida) checked @endif value="1"
                            id="alerta_mensagem_recebida">
                    </div>
                </div>
            </div>
         ...
         <div class="row">
            <div class="col-6">
                <div class="form-check">
                    <label class="form-check-label" style="color: red" for="alerta_mensagem_recebida">
                        BLOQUEAR ENTRADA DE MENSAGEM
                    </label>
                    <input type="hidden" name="bloquear_entrada_mensagem" value="0">
                    <input class="form-check-input" name="bloquear_entrada_mensagem" type="checkbox"
                        @if ($model->bloquear_entrada_mensagem) checked @endif value="1" id="bloquear_entrada_mensagem">
                </div>
            </div>
        </div>
