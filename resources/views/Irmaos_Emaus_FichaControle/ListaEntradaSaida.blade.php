        ...
        <div class="container">
            ...
            <div class="card">
                <div class="badge bg-primary text-wrap" style="width: 100%;font-size: 24px;lign=˜Center˜">
                    RELATÓRIO DE ENTRADAS E SAIDAS PARA SISTEMA DE GERENCIAMENTO ADMINISTRATIVO E CONTÁBIL
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="card-header">
                    <div class="badge bg-info text-wrap" style="width: 100%;font-size: 24px">
                        <p>Total de ENTRADAS e SAIDAS no sistema de gerenciamento administrativo e contábil:
                            {{ $model->count() ?? 0 }}</p>
                    </div>
                </div>
                    <div class="card-header">
                    ...
                    <tbody>
                        @foreach ($model as $Model)
                            <tr>
                                ...
                                <td class="">
                                    {{ $Model->TipoEntradaSaida ? $Model->TipoEntradaSaida : 'Sem tipo' }}
                                </td>
                                 <td class="">
                                   {{ $Model->DataEntradaSaida ? \Carbon\Carbon::parse($Model->DataEntradaSaida)->format('d/m/Y') : 'Sem data' }}
                                </td>
