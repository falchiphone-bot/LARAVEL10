    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Tanabi SAF 2 X 2 Rio Preto</td>
        </tr>
        <tr class="border-b border-gray-700">
            ...
            <a href="{{ route('download', ['id_arquivo' => 40816]) }}"
             ...
             <tr>
                <th class="bg-gray-600 text-left px-6 py-4">Jogo completo</th>
                    ...
                    <div class="mt-4">
                        <iframe width="480" height="315" src="https://www.youtube.com/embed/qbisN_zRMas" title="AO VIVO COM IMAGENS - TANABI X RIO PRETO - PAULISTA SUB-17" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                    </td>
             </tr>
             ...
             <tr>
                <th class="bg-gray-600 text-left px-6 py-4">Primeiro gol do Tanabi por João Pedro Augusto de Carvalho - (João)</th>
                    ...
                    <div class="mt-4">
                        <iframe width="480" height="320" src="https://www.youtube.com/embed/qbisN_zRMas?start=1784" title="Primeiro gol do Tanabi por João Carvalho - João - TANABI X SANTA FÉ - PAULISTA SUB-17"
             ...
             <tr>
                <th class="bg-gray-600 text-left px-6 py-4">Segundo gol do Tanabi por João Pedro Augusto de Carvalho - (João)</th>
                    ...
                    <div class="mt-4">
                        <iframe width="480" height="320" src="https://www.youtube.com/embed/qbisN_zRMas?start=6886" title="Primeiro gol do Tanabi por João Carvalho - João - TANABI X SANTA FÉ - PAULISTA SUB-17"
                         frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                    </td>
             </tr>
