    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Santa Fé FC 2 X 0 Tanabi SAF</td>
        </tr>
        <tr class="border-b border-gray-700">
        ...
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Estádio Municipal Evandro de Paula / Santa Fé do Sul</td>
        </tr>
        <tr>
          <th class="bg-gray-600 text-left px-6 py-4">Súmula</th>
          <td class="px-6 py-4 text-center">
            <a href="{{ route('download', ['id_arquivo' => 40734]) }}"
        ...
        <tr>
            ...
            <td class="px-6 py-4 text-center">
              ...
              src="https://www.youtube.com/embed/n8NdwPCAQ_c"
