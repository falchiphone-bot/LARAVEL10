    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Catanduva FC 0 x 0 Tanabi SAF  Penalti Catanduva FC 4 x 2 Tanabi SAF</td>
        </tr>
        <tr class="border-b border-gray-700">
        ...
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Estádio Municipal Silvio Salles / Catanduva</td>
        </tr>
        <tr>
          <th class="bg-gray-600 text-left px-6 py-4">Súmula</th>
          <td class="px-6 py-4 text-center">
            <a href="{{ route('download', ['id_arquivo' => 40839]) }}"
