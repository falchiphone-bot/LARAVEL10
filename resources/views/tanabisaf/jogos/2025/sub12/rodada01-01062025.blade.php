    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Tanabi SAF 1 x 2 Inter Bebedouro Penalti Tanabi SAF 3 x 4 Inter Bebedouro</td>
        </tr>
        <tr class="border-b border-gray-700">
        ...
        <tr>
          ...
          <td class="px-6 py-4 text-center">
            <a href="{{ route('download', ['id_arquivo' => 40826]) }}"
