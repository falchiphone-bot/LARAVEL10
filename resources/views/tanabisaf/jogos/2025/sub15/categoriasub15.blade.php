...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub15.rodada03') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 3
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub15.rodada04') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 4
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub15.rodada06') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 6
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub15.rodada07') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 7
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub15.rodada08') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 8
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub15.rodada09') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 9
        </a>
    </li>
