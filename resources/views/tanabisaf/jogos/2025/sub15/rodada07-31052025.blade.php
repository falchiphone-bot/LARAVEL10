...
<body class="bg-green-900  text-white min-h-screen flex flex-col items-center pt-32 px-4">
  ...
  <table class="w-full max-w-md bg-green shadow-lg rounded-xl overflow-hidden">
    ...
    <tr class="border-b">
      ...
      <td class="px-6 py-4">Votuporanguense 1 x 1 Tanabi SAF </td>
    </tr>
    <tr class="border-b">
    ...
    <tr class="border-b">
     ...
     <tr class="border-b">
        ...
        <p class="text-white-900 text-lg text-center mt-4">
            <a href="{{ route('download', ['id_arquivo' => 40829]) }}"target="_blank" rel="noopener noreferrer" >Baixar Arquivo PDF do jogo</a>
        </p>
