...
<body class="bg-green-900  text-white min-h-screen flex flex-col items-center pt-32 px-4">
  ...
  <table class="w-full max-w-md bg-green shadow-lg rounded-xl overflow-hidden">
    ...
    <caption class="text-xl font-bold text-blue-900 bg-blue-100 py-4">
      Paulista SUB15 - 2025 | Rodada 07
    </caption>
    <tr class="border-b">
      <th class="bg-gray-500 text-left px-6 py-4 w-1/3">Jogo</th>
          <td class="px-6 py-4">América 3 x 0 Tanabi SAF</td>
    </tr>
    <tr class="border-b">
    ...
    <tr class="border-b">
     ...
     <tr class="border-b">
        ...
        <p class="text-white-900 text-lg text-center mt-4">
            <a href="{{ route('download', ['id_arquivo' => 40846]) }}"target="_blank" rel="noopener noreferrer" >Baixar Arquivo PDF do jogo</a>
        </p>
        ...
        <tr>
            ...
            <td class="px-6 py-4 text-center">
              ...
              <div class="mt-4">
<iframe width="480" height="315" src="https://www.youtube.com/embed/RuPazGVekcA" title="AO VIVO COM IMAGENS - AMÉRICA X TANABI  - PAULISTA SUB-15" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            </td>
          </tr>
