    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-800">
          ...
          <td class="px-6 py-4">Tanabi SAF 1 x 0 CFC TIETÊ</td>
        </tr>
        <tr class="border-b border-gray-700">
          <th class="bg-gray-600 text-left px-6 py-4">Data</th>
          <td class="px-6 py-4">25/07/2025</td>
        </tr>
        <tr class="border-b border-gray-700">
        ...
        <tr>
          ...
          <td class="px-6 py-4 text-center">
            <a href="{{ route('download', ['id_arquivo' => 40953]) }}"
          ...
          <tr>
            <th class="bg-gray-600 text-left px-6 py-4">Jogo completo</th>
                 <td class="px-6 py-4 text-center">
                    ...
                    <div class="mt-4">
                        <iframe width="480" height="320" src="https://www.youtube.com/embed/2fadc1ZiJGE" title="AO VIVO COM IMAGENS  TANABI  X TIETÊ - PAULISTA SUB-20" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </td>
            </tr>
            ...
            <td class="px-6 py-4 text-center">
              ...
              <div class="mt-4">
                <iframe width="480" height="320"
                        src="https://www.youtube.com/embed/2fadc1ZiJGE?start=2530"
