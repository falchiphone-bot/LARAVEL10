...
<body class="bg-green-900  text-white min-h-screen flex flex-col items-center pt-32 px-4">
  ...
  <ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.categoriasub20') }}"
  ...
  <ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada01') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 1
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada02') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 2
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada03') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 3
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada04') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 4
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada05') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 5
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada06') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 6
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada07') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 7
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada12') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 12
        </a>
    </li>
...
<ul class="text-gray-300 text-lg text-center mt-4">
    <li>
        <a href="{{ url('tanabisaf.jogos.2025.sub20.rodada13') }}"
           class="block p-2 text-blue-400 underline hover:text-red-500">
            Rodada 13
        </a>
    </li>
