    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-800">
          ...
          <td class="px-6 py-4">XV JAU 5 X 4 Tanabi SAF</td>
        </tr>
        ...
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Estádio Zezinho Magalhães / Jaú<<td>
        </tr>
        <tr>
        ...
        {{-- <tr>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-center">
              ...
              <div class="mt-4">
<iframe width="480" height="315" src="https://www.youtube.com/embed/5kT59vcLmq8" title="CAMPEONATO PAULISTA DE FUTEBOL SUB 20 - XV DE JAÚ 5X4 TANABI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
                </td>
