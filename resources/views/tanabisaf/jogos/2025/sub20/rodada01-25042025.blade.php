    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-800">
          ...
          <td class="px-6 py-4">Atlético Guaratinguetá SAF 0 X 3 Tanabi SAF</td>
        </tr>
        ...
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Estádio Municipal Professor Dario Rodrigues Leite (Prof. Dario Rodrigues Leite) - Guaratinguetá</td>
        </tr>
        <tr>
          <th class="bg-gray-600 text-left px-6 py-4">Súmula</th>
          <td class="px-6 py-4 text-center">
            <a href="{{ route('download', ['id_arquivo' => 40753]) }}"
        ...
        {{-- <tr>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-center">
              ...
              <div class="mt-4">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/OOYwl4xSTe4" title="AO VIVO COM IMAGENS | AC GUARATINGUETÁ X TANABI - CAMPEONATO PAULISTA SUB20" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          ...
          <tr>
            <th class="bg-gray-600 text-left px-6 py-4">Primeiro gol de Guilherme Biasioli Alves de Morais</th>
            <td class="px-6 py-4 text-center">
          ...
          <tr>
            <th class="bg-gray-600 text-left px-6 py-4">Segundo gol de Mateus dos Santos Pipino - (Mateus)</th>
            <td class="px-6 py-4 text-center">
          ...
          <tr>
            <th class="bg-gray-600 text-left px-6 py-4">Terceiro gol de Giovani Cesar Guerra - (Giovani)</th>
            <td class="px-6 py-4 text-center">
