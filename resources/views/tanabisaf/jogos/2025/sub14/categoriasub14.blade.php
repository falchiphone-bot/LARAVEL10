...
<head>
  ...
  @include('tanabisaf.header')
            ...
            <ul class="text-gray-300 text-lg text-center mt-4">
                <li>
                    <a href="{{ url('tanabisaf.jogos.2025.sub14.rodada01') }}"
                    class="block p-2 text-blue-400 underline hover:text-red-500">
                        Rodada 1
                    </a>
                </li>
            ...
            <ul class="text-gray-300 text-lg text-center mt-4">
                <li>
                    <a href="{{ url('tanabisaf.jogos.2025.sub14.rodada02') }}"
                    class="block p-2 text-blue-400 underline hover:text-red-500">
                        Rodada 2
                    </a>
                </li>
            ...
            <ul class="text-gray-300 text-lg text-center mt-4">
                <li>
                    <a href="{{ url('tanabisaf.jogos.2025.sub14.rodada03') }}"
                    class="block p-2 text-blue-400 underline hover:text-red-500">
                        Rodada 3
                    </a>
                </li>
            ...
            <ul class="text-gray-300 text-lg text-center mt-4">
                <li>
                    <a href="{{ url('tanabisaf.jogos.2025.sub14.rodada04') }}"
                    class="block p-2 text-blue-400 underline hover:text-red-500">
                        Rodada 4
                    </a>
                </li>
