...
<head>
  ...
  @include('tanabisaf.header')
    ...
    <body class="bg-green-900  text-white min-h-screen flex flex-col items-center pt-32 px-4">
            ...
            <ul class="text-gray-300 text-lg text-center mt-4">
                <li>
                    <a href="{{ url('tanabisaf.jogos.2025.sub13.rodada01') }}"
                    class="block p-2 text-blue-400 underline hover:text-red-500">
                        Rodada 1
                    </a>
                </li>
            ...
            <ul class="text-gray-300 text-lg text-center mt-4">
                <li>
                    <a href="{{ url('tanabisaf.jogos.2025.sub13.rodada02') }}"
                    class="block p-2 text-blue-400 underline hover:text-red-500">
                        Rodada 2
                    </a>
                </li>
            ...
            <ul class="text-gray-300 text-lg text-center mt-4">
                <li>
                    <a href="{{ url('tanabisaf.jogos.2025.sub13.rodada03') }}"
                    class="block p-2 text-blue-400 underline hover:text-red-500">
                        Rodada 3
                    </a>
                </li>
            ...
            <ul class="text-gray-300 text-lg text-center mt-4">
                <li>
                    <a href="{{ url('tanabisaf.jogos.2025.sub13.rodada04') }}"
                    class="block p-2 text-blue-400 underline hover:text-red-500">
                        Rodada 4
                    </a>
                </li>
