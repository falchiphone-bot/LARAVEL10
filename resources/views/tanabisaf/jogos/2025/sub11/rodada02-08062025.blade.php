    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Catanduva FC 1 x 1 Tanabi SAF  Penalti Catanduva FC 4 x 1 Tanabi SAF</td>
        </tr>
        <tr class="border-b border-gray-700">
        ...
        <tr>
          ...
          <td class="px-6 py-4 text-center">
            <a href="{{ route('download', ['id_arquivo' => 40837]) }}"
