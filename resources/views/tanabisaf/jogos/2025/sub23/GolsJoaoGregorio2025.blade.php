...
<head>
  ...
  <title>Gols de João Vitor de Oliveira Gregorio - TANABI SAF Sub-23 (2025)</title>
  <script src="https://cdn.tailwindcss.com"></script>
  @include('tanabisaf.header')
</head>
<body class="bg-green-900 text-white min-h-screen flex flex-col items-center pt-20 px-4">

  <h1 class="text-3xl font-bold mb-6 text-yellow-400">Gols de João Vitor de Oliveira Gregorio no Sub-23 (2025)</h1>
  ...
  <footer class="mt-10 text-gray-400 text-sm">
    <p>&copy; 2025 TANABI SAF. Todos os direitos
