    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-800">
          ...
          <td class="px-6 py-4">ECUS 0 X 2 Tanabi SAF</td>
        </tr>
        <tr class="border-b border-gray-700">
          <th class="bg-gray-600 text-left px-6 py-4">Data</th>
          <td class="px-6 py-4">23/08/2025</td>
        </tr>
        <tr class="border-b border-gray-700">
        ...
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Estádio Municipal Francisco Marques Figueira / Suzano</td>
        </tr>

        <tr>
          <th class="bg-gray-600 text-left px-6 py-4">Súmula</th>
          <td class="px-6 py-4 text-center">
            <a href="{{ route('download', ['id_arquivo' => 41000]) }}"
        ...
        {{-- <tr>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-center">
                 ...
                 <div class="mt-4">
                    <iframe width="480" height="320" src="https://www.youtube.com/embed/NYOSlQFd2lQ" title="JOGO COMPLETO: ECUS X TANABI  FINAL IDA | PAULISTA SUB-23 2ª DIVISÃO SICREDI 2025" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </td>
          </tr>
...
<tr>
            <th class="bg-gray-600 text-left px-6 py-4">Primeiro gol de Breno da Silva Fonseca - (BRENO) </th>
            <td class="px-6 py-4 text-center">

              <div class="mt-4">
                <iframe width="480" height="315"
                        src="https://www.youtube.com/embed/NYOSlQFd2lQ?start=3473"
        ...
        <tr>
            ...
            <td class="px-6 py-4 text-center">
              ...
              <div class="mt-4">
                <iframe width="480" height="315"
                          src="https://www.youtube.com/embed/NYOSlQFd2lQ?start=7474"
                        title="YouTube video player"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
...
MATÉRIA COM MAÇOLA NA TV TEM PROGRAMA TEM ESPORTES em 14.08.2025
