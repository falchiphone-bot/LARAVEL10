    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        ...
        <tr>
            ...
            <td class="px-6 py-4 text-center">
              <a href="{{ route('download', ['id_arquivo' => 40774]) }} target="_blank" rel="noopener noreferrer">
                 class="text-blue-300 font-semibold hover:text-blue-400 hover:underline transition duration-200"
                 target="_blank" rel="noopener noreferrer">
...
<tr>
    ...
    <td class="px-6 py-4 text-center">
        <a href="{{ route('download', ['id_arquivo' => 40989]) }}"
           class="inline-flex items-center gap-2 px-4 py-2 bg-gray-800 rounded-lg shadow-md text-blue-300 font-semibold hover:text-blue-400 hover:underline hover:bg-gray-700 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
           target="_blank" rel="noopener noreferrer">
            <!-- Ícone PDF com hover -->
