    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-800">
          ...
          <td class="px-6 py-4">Mauaense 0 X 0 Tanabi SAF </td>
        </tr>
        <tr class="border-b border-gray-700">
          <th class="bg-gray-600 text-left px-6 py-4">Data</th>
          <td class="px-6 py-4">12/07/2025</td>
        </tr>
        <tr class="border-b border-gray-700">
        ...
        <tr class="border-b border-gray-700">
          ...
          <td class="px-6 py-4">Estádio Municipal Pedro Benedetti / Mauá</td>
        </tr>
        ...
        {{-- <tr>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-center">
                 ...
                 <div class="mt-4">
                  <iframe width="480" height="315" src="https://www.youtube.com/embed/9oij1960NVQ" title="JOGO COMPLETO: MAUAENSE X TANABI | RODADA 13 | PAULISTA SUB-23 2ª DIVISÃO SICREDI 2025" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </td>
          </tr>
