    ...
    <table class="w-full text-sm md:text-base">
      <tbody>
        <tr class="border-b border-gray-800">
          ...
          <td class="px-6 py-4">Tanabi SAF 1 X 0 Assisense</td>
        </tr>
        <tr class="border-b border-gray-700">
          <th class="bg-gray-600 text-left px-6 py-4">Data</th>
          <td class="px-6 py-4">02/08/2025</td>
        </tr>
        <tr class="border-b border-gray-700">
        ...
        <tr>
          ...
          <td class="px-6 py-4 text-center">
            <a href="{{ route('download', ['id_arquivo' => 40958]) }}"
        ...
        <tr>
            ...
            <td class="px-6 py-4 text-center">
              <a href="{{ route('download', ['id_arquivo' => 40960]) }}"
                 class="text-blue-300 font-semibold hover:text-blue-400 hover:underline transition duration-200"
                 target="_blank" rel="noopener noreferrer">
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-center">
                 ...
                 <div class="mt-4">
                    <iframe width="480" height="320" src="https://www.youtube.com/embed/PJ0jO4D9flw" title="JOGO COMPLETO: TANABI X ASSISENSE | RODADA 16 | PAULISTA SUB-23 2ª DIVISÃO SICREDI 2025" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </td>
          </tr>
        ...
        <tr>
            <th class="bg-gray-600 text-left px-6 py-4">Gol de Joao Vitor de Oliveira Gregorio - (Joao)   </th>
            <td class="px-6 py-4 text-center">

              <div class="mt-4">
                <iframe width="480" height="315"
                        src="https://www.youtube.com/embed/PJ0jO4D9flw?start=5820"
