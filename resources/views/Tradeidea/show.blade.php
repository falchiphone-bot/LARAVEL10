        ...
        <div class="container">
            ...
            <div class="card">
                <div class="badge bg-primary text-wrap" style="width: 100%;">
                    PREPARADORES/PROFESSORES/TREINADORES ESPORTIVA DO SISTEMA DE GERENCIAMENTO ADMINISTRATIVO E CONTÁBIL
                </div>
                ...
                <div class="row">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('Preparadores.index') }}">Retornar para a lista</a>
                        </div>
                    </div>
                </div>
            </div>
