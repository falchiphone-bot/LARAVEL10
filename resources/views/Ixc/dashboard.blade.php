                    ...
                    <table class="table table-success table-striped">
                        <thead class="table-light">
                            ...
                            ; font-size: 16px;a lign=˜Center˜ ">
                                Opções para o sistema IXC NET RUBI
                            </div>
                        </thead>
                        <tbody>
                            ...
                            @can('RECEBERIXCNETRUBI - LISTAR')
                                <tr>
                                    <th>
                                        ...
                                        <nav class="navbar navbar-red" style="background-color: hsla(234, 92%, 47%, 0.096);">
                                            <a class="btn btn-success" href="/ReceberIxc">Recebimentos IXC NET RUBI por período</a>
                                        </nav>

                                        <nav class="navbar navbar-red" style="background-color: hsla(234, 92%, 47%, 0.096);">
                                            <a class="btn btn-success" href="/Ixc/Clientes/contratostv">Contratos TV</a>
                                        </nav>
