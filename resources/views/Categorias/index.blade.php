                ...
                <form method="GET" action="{{ route('Categorias.index') }}" class="mb-3">
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-12 col-md-6 mt-2">
                            ...
                            <a href="{{ route('Categorias.index', array_merge(request()->except(['page']), ['clear'=>1])) }}" class="btn btn-outline-secondary">Limpar</a>
                            @can('CATEGORIAS - EXPORTAR')
                            <a href="{{ route('Categorias.export', request()->all()) }}" class="btn btn-outline-success">Exportar CSV</a>
                            <a href="{{ route('Categorias.exportXlsx', request()->all()) }}" class="btn btn-outline-success">Exportar XLSX</a>
                            <a href="{{ route('Categorias.exportPdf', request()->all()) }}" class="btn btn-outline-danger">Exportar PDF</a>
                        ...
                        <div class="col-12 col-md-3 form-check mt-2">
                            <input class="form-check-input" type="checkbox" value="1" id="remember" name="remember" {{ request('remember', old('remember', session()->has('categorias.index.filters') ? '1' : '')) ? 'checked' : '' }}>
                    ...
                    <thead>
                        <tr>
                            <th scope="col" class="px-6 py-4">
                                ...
                                <a href="{{ route('Categorias.index', array_merge(request()->except(['page']), ['sort' => 'nome', 'dir' => request('dir')==='asc' && request('sort')==='nome' ? 'desc' : 'asc'])) }}">
...
<div class="modal fade" id="exportPdfAdvancedModal" tabindex="-1" aria-labelledby="exportPdfAdvancedModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form method="GET" action="{{ route('Categorias.exportPdf') }}" target="_blank">
                <div class="modal-body">
                    <input type="hidden" name="nome" value="{{ request('nome') }}">
                    <input type="hidden" name="tipo_esporte" value="{{ request('tipo_esporte') }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="header_title" class="form-control" value="Categorias">
                        </div>
                        <div class="col-md-6">
