...
@if ($NomeAtendido->transferido_para)
       <span style="color: green; text-align: center; display: block; margin: 0 auto;font-weight: bold">Transferido para:</span>
       <span style="color: green; text-align: center; display: block; margin: 0 auto;font-weight: bold"> {{ $NomeAtendido->transferido_para }}</span>
@endif
