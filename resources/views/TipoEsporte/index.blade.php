    ...
    <div class="py-5 bg-light">
        <div class="container">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('TipoEsporte.index') }}" class="mb-3">
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <a href="{{ route('TipoEsporte.index', array_merge(request()->except(['page']), ['clear'=>1])) }}" class="btn btn-outline-secondary">Limpar</a>
                            <a href="{{ route('TipoEsporte.export', request()->all()) }}" class="btn btn-outline-success">Exportar CSV</a>
                            <a href="{{ route('TipoEsporte.exportXlsx', request()->all()) }}" class="btn btn-outline-success">Exportar XLSX</a>
                        </div>
                        <div class="col-12 col-md-3 form-check mt-2">
                            <input class="form-check-input" type="checkbox" value="1" id="remember" name="remember" {{ request('remember', old('remember', session()->has('tipoesporte.index.filters') ? '1' : '')) ? 'checked' : '' }}>
                    ...
                    <thead>
                        <tr>
                            <th scope="col" class="px-6 py-4">
                                ...
                                <a href="{{ route('TipoEsporte.index', array_merge(request()->except(['page']), ['sort' => 'nome', 'dir' => request('dir')==='asc' && request('sort')==='nome' ? 'desc' : 'asc'])) }}">
