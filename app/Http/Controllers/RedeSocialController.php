...
class RedeSocialController  extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['permission:REDE SOCIAL - LISTAR'])->only('index');
        $this->middleware(['permission:REDE SOCIAL - INCLUIR'])->only(['create', 'store']);
        $this->middleware(['permission:REDE SOCIAL - EDITAR'])->only(['edit', 'update']);
        $this->middleware(['permission:REDE SOCIAL - VER'])->only(['edit', 'update']);
        $this->middleware(['permission:REDE SOCIAL - EXCLUIR'])->only('destroy');
    }
