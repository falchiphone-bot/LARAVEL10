...
Route::resource('RedeSocialUsuarios', App\Http\Controllers\RedeSocialUsuarioController::class);
    ...
    Route::get('PlanoContas/BalanceteEmpresa', [App\Http\Controllers\PlanoContaController::class, 'BalanceteEmpresa'])->name('planocontas.BalanceteEmpresa');
...
Route::resource('LancamentosDocumentos', App\Http\Controllers\LancamentosDocumentosController::class);
    ...
    // Route::post('LeituraArquivo/SelecionaDatasFaturaEmAberto', [App\Http\Controllers\LeituraArq
    uivoController::class, 'SelecionaDatasFaturaEmAberto'])->name('LeituraArquivo.SelecionaDatasFaturaEmAberto');
