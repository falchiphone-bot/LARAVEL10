...
Route::get('pdf/GerarPDF', [App\Http\Controllers\ExtratoConectCarController::class, 'GerarPDF'])->name('pdf.gerarpdf');
 ...
 Route::post('/whatsapp/enviarMensagemEncerramentoAtendimento/{id}', [App\Http\Controllers\ApiController::class, 'enviarMensagemEncerramentoAtendimento'])
 ...
 Route::get('/whatsapp/atendimentoWhatsappFiltroTelefone/{id}', [App\Http\Controllers\ApiController::class, 'atendimentoWhatsappFiltroTelefone'])->name('whatsapp.atendimentoWhatsappFiltroTelefone');
