...
Route::post('/openai/variations/save-alloc-fato', [\App\Http\Controllers\AssetVariationController::class, 'saveAllocFato'])->name('openai.variations.saveAllocFato');
...
Route::get('/openai/portfolio/cash/events/export/by-asset/csv', [\App\Http\Controllers\InvestmentAccountCashEventController::class,'exportByAssetCsv'])
    ->middleware(['auth','verified','can:CASH EVENTS - LISTAR'])
    ->name('cash.events.by-asset.export.csv');
...
// Atualização inline de metas e probabilidades nos eventos de caixa
...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/lancamentos/preview-despesas-excel/export-prepare-xlsx', [\App\Http\Controllers\LancamentosController::class,'exportPreviewDespesasPrepareExcel'])->name('lancamentos.preview.despesas.exportPrepareXlsx');
...
Route::middleware(['auth','verified','can:backup.executar.ftp'])
    ...
    ->group(function () {
        ...
        Route::get('/pull-report', [FtpDownloadController::class, 'pullReport'])->name('pull.report');
    });
/*
|--------------------------------------------------------------------------
| Web Routes
...
Route::get('tanabisaf.jogos.2025.sub23.rodada10', function ()
    ...
    ->name('tanabisaf.jogos.2025.sub23.rodada20');
     ...
     Route::get('tanabisaf.jogos.2025.sub23.GolsAndre2025', function ()
 { return view('tanabisaf.jogos.2025.sub23.GolsAndre2025');})
    ->name('tanabisaf.jogos.2025.sub23.GolsAndre2025');
...
Route::post('Caixa/ExtratoCaixa', [App\Http\Controllers\ExtratoCaixaController::class, 'ExtratoCaixa'])->name('Caixa.ExtratoCaixa');
    ...
    Route::get('/openai/records/daily-comparison-export', [\App\Http\Controllers\OpenAIChatRecordController::class, 'exportDailyComparison'])->name('openai.records.dailyComparison.export');
    Route::post('/openai/records/save-variation', [\App\Http\Controllers\OpenAIChatRecordController::class, 'saveVariation'])->name('openai.records.saveVariation');
    ...
    Route::post('/openai/records/{record}/from-quote', [\App\Http\Controllers\OpenAIChatRecordController::class, 'createFromQuote'])->name('openai.records.createFromQuote');
